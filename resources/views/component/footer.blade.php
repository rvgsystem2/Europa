        ...
        <div>
          ...
          <div class="space-y-4 text-gray-800">
            <div class="flex items-start space-x-3">
                <img width="40" height="40" src="https://img.icons8.com/fluency/48/marker.png" alt="marker"/>
            ...
            <div class="flex items-center space-x-2">
                <img width="40" height="40" src="https://img.icons8.com/fluency/48/secured-letter.png" alt="secured-letter"/>
              <a href="mailto:info@europaolympiad.org" class="text-sm hover:text-black transition">info@europaolympiad.org</a>
            </div>
            <div class="flex items-center space-x-2">
                <img width="40" height="40" src="https://img.icons8.com/arcade/64/phone.png" alt="phone"/>
              <div>
