    ...
    <div class="container mx-auto flex justify-between md:justify-evenly items-center">
        ...
        <ul class="hidden md:flex gap-6" id="menu">
            ...
            <li class="relative">
                ...
                <ul class="hidden absolute left-0 mt-2 w-48 bg-white text-black shadow-md rounded-md z-10"
                    id="dropdown">
                    <li><a href="{{route('iso_exam')}}" class="block px-4 py-2 hover:bg-gray-200">ISO Exam </a></li>
                    <li><a href="{{route('iso_1')}}" class="block px-4 py-2 hover:bg-gray-200">Class 1</a></li>
                    <li><a href="{{route('iso_2')}}" class="block px-4 py-2 hover:bg-gray-200">Class 2</a></li>
                    <li><a href="{{route('iso_3')}}" class="block px-4 py-2 hover:bg-gray-200">Class 3</a></li>
                    <li><a href="{{route('iso_4')}}" class="block px-4 py-2 hover:bg-gray-200">Class 4</a></li>
                    <li><a href="{{route('iso_5')}}" class="block px-4 py-2 hover:bg-gray-200">Class 5</a></li>
                    <li><a href="{{route('iso_6')}}" class="block px-4 py-2 hover:bg-gray-200">Class 6</a></li>
                    <li><a href="{{route('iso_7')}}" class="block px-4 py-2 hover:bg-gray-200">Class 7</a></li>
                    <li><a href="{{route('iso_8')}}" class="block px-4 py-2 hover:bg-gray-200">Class 8</a></li>
                    <li><a href="{{route('iso_9')}}" class="block px-4 py-2 hover:bg-gray-200">Class 9</a></li>
                    <li><a href="{{route('iso_10')}}" class="block px-4 py-2 hover:bg-gray-200">Class 10</a></li>
